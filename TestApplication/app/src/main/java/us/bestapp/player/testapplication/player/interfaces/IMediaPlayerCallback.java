...
public interface IMediaPlayerCallback {
     ...
     * 添加进度监听事件
     */
    boolean addOnProgressUpdateListener(IPlayCallback.onProgressUpdateListener listener);

    /**
     * 移除进度监听事件
     */
    boolean removeOnProgressUpdateListener(IPlayCallback.onProgressUpdateListener listener);
