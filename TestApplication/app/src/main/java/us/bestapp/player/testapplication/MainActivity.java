...
import us.bestapp.player.testapplication.player.model.Song;
import us.bestapp.player.testapplication.player.utils.CommonUtils;
import us.bestapp.player.testapplication.player.utils.PlayServiceHelperUtils;
...
public class MainActivity extends AppCompatActivity implements ServiceConnection {
    ...
    private IMusicHandleBinder mBinder;
    ...
    protected void onCreate(Bundle savedInstanceState) {
            ...
            public void handleMessage(Message msg) {
                switch (msg.what) {
                    ...
                    case 0x3:
                        ...
                        ((MusicAdapter) mLvPlayList.getAdapter()).notifyDataSetChanged();
        ...
        mLvPlayList.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                AbsMusic music = (AbsMusic) mAdapter.getItem(position);
    ...
    public void onServiceConnected(ComponentName name, IBinder service) {
        this.mBinder = (IMusicHandleBinder) service;
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                for (int i = 0; i < CommonUtils.FILE_NAME.length; i++) {
                    ...
                    song.url = CommonUtils.URL_MUSICS[i];
                    list.add(song);
                }
