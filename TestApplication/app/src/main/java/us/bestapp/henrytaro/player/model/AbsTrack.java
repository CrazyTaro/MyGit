...
public abstract class AbsTrack<K> {
    ...
    public boolean isInstanceOf(Object obj) {
        ...
        if (obj == null) {
            ...
            return true;
        } else if (obj instanceof us.bestapp.henrytaro.player.model.AbsTrack) {
            return true;
        } else {
            return false;
        }
    ...
    public boolean equals(Object o) {
        if (isInstanceOf(o)) {
            us.bestapp.henrytaro.player.model.AbsTrack m = (us.bestapp.henrytaro.player.model.AbsTrack) o;
            //判断两个音乐是否相同,通过key确定
